      ...
      <React.Fragment>
        ...
        <div className="container bg-3 text-left">  
          <div className="row bg-box">
            ...
            <p>All we want is your company, love, good vibes and photos, so please amateur and professional photographers alike take photos and share them. if you really feel like you need to do something then give a donation to the Animal Charity of your choice.</p>
